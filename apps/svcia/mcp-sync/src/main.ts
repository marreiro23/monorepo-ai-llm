...
server.registerTool(
  'sync_jobs_list',
  {
    ...
    description:
      'Lista jobs de sincronizacao por GET /sync/jobs. Somente leitura.',
    inputSchema: {
...
server.registerTool(
  'sync_status',
  {
    ...
    description:
      'Resume o estado de sincronizacao a partir de GET /sync/jobs. Somente leitura.',
    inputSchema: {},
  },
  async () => {
...
server.registerTool(
  'sync_sites_list',
  {
    ...
    description:
      'Lista sites sincronizados por GET /sync/sites. Somente leitura.',
    inputSchema: {
      limit: z.number().int().positive().max(200).optional(),
    },
  },
...
server.registerTool(
  'sync_users_list',
  {
    ...
    description:
      'Lista usuarios sincronizados por GET /sync/users. Somente leitura.',
    inputSchema: {
      limit: z.number().int().positive().max(200).optional(),
    },
  },
