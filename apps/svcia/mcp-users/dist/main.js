...
server.registerTool('users_list', {
    title: 'List Users',
    description: 'Lista usuarios do dominio users por GET /users. Somente leitura.',
    inputSchema: {
...
server.registerTool('users_search', {
    title: 'Search Users',
    description: 'Pesquisa usuarios por nome ou email usando GET /users e filtro local. Somente leitura.',
    inputSchema: {
