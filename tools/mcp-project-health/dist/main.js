...
server.registerTool('docker_compose_check', {
...
server.registerTool('migration_paths_fix', {
...
server.registerTool('docs_check', {
...
}, async ({ categories, timeoutMs }) => toToolResult(await runSmoke({
    repoRoot: REPO_ROOT,
    categories: categories,
    timeoutMs
})));
server.registerTool('database_check', {
