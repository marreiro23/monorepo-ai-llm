...
async function runMigrationsIfNeeded(repoRoot, dsName) {
...
export async function checkDatabase(repoRoot) {
    ...
    const corrections = correctionMessages.map((c) => ({
